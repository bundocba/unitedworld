...
$document->addScript(JURI::Root().'templates/beez_20/javascript/jquery/jquery-1.8.3.js');
$document->addScript(JURI::Root().'templates/beez_20/javascript/jquery/jquery-ui-1.9.2.custom.js');

$document->addStyleSheet(JURI::Root().'templates/beez_20/javascript/jquery/css/smoothness/jquery-ui-1.9.2.custom.min.css');
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_fw_twpost&view=articles');?>" method="post" name="adminForm" id="adminForm">
	...
	if(isset($_GET['id'])){
		...
		$redirect = 'window.location = "'.JURI::base().'index.php?option=com_fw_twpost&view=articles"';
