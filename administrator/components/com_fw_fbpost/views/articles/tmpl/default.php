...
?>
<form action="<?php echo JRoute::_('index.php?option=com_fw_fbpost&view=articles');?>" method="post" name="adminForm" id="adminForm">
	...
	if(isset($_GET['id'])){
		...
		$redirect = 'window.location = "'.JURI::base().'index.php?option=com_fw_fbpost&view=articles"';
