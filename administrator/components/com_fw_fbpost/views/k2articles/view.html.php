...
class Fw_fbpostViewK2Articles extends JViewLegacy
{
	protected $items;
	...
	{
		$db		= JFactory::getDbo();
		$query  = "SELECT DISTINCT(article_id) FROM #__k2articles_history_post";
		$db->setQuery($query);
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('Articles :: K2 Post Facebook'), 'article.png');
		JToolBarHelper::preferences('com_fw_fbpost', 400, 600, JText::_('Configuration'));
		JToolBarHelper::custom('k2articles.post_face', 'checkin.png', 'checkin.png', 'POST', true);
	}
}
