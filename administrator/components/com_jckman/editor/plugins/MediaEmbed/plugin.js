           ...
           CKEDITOR.dialog.add( 'MediaEmbedDialog', function ()
           {
              return {
                 ...
                 contents :
                  ...
                  onOk : function()
                 {
		/*		 commented out by AW non recommended way of getting 
		  ...
		  */
		   // use standardized DOM-centric code for getting Iframe data
		    if(CKEDITOR.document.getById('iframeMediaEmbed'))
			{
				var dom = CKEDITOR.document.getById('iframeMediaEmbed');
				var content = dom.getFrameDocument().getById('embed').getValue();		
			}
