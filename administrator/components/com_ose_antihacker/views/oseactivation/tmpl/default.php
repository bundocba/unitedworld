...
oseHTML::script("administrator/components/com_ose_antihacker/views/oseactivation/js/script.js",'1.5');
?>
<div id = "oseheader">
  <div class="container">
...
?>
  ...
  <br />
		<div class="grid-title">
					Due to unauthorized distribution of the software, we add the activation function into the software for slightly higher protection of intelligent properties. We apologize for the inconvenience but hope you could understand it. Please enter your OSE ID and Password, and click the Activation Button to activate the component.
		</div>
		<div id ='aboutose'>
			<table width ="100%">
			<tr>
