...
include(JPATH_ADMINISTRATOR.DS.'components/com_ose_antihacker/views/duplicated/tmpl/js.php');
?>
<div id = "oseheader">
  <div class="container">
...
?>
	<div class="section">
		...
		<div class="grid-title"><?php echo JText::_('THIS_PANEL_ALLOW_YOU_TO_RESOLVE_IP_CONFLICTS_BETA'); ?></div>
			<div id ='oseATHDuplicated'></div>
	</div>
  </div>
</div>
<?php
