...
include(JPATH_ADMINISTRATOR.DS.'components/com_ose_antihacker/views/tools/tmpl/js.php');
?>
<div id = "oseheader">
  <div class="container">
...
?>
	<div class="section">
		...
		<div class="grid-title"><?php echo JText::_('PLEASE_CREATE_THE_HTPASSWORD_HERE'); ?></div>
