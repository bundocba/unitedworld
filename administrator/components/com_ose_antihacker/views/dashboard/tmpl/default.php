...
include(JPATH_ADMINISTRATOR.DS.'components/com_ose_antihacker/views/dashboard/tmpl/js.php');
...
?>
	<div class="section">
		...
		<div class="grid-title"><?php echo JText::_('OSE_ANTI-HACKER_LOGGED_IPS_IN_THE_LAST_10_DAYS'); ?></div>
