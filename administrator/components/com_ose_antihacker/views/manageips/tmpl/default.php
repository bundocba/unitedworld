...
include(JPATH_ADMINISTRATOR.DS.'components/com_ose_antihacker/views/manageips/tmpl/js.php');
?>
<div id = "oseheader">
  <div class="container">
...
?>
	<div class="section">
		...
		<div class="grid-title"><?php echo JText::_('PLEASE_SELECT_THE_IP_RULES_AND_CLICK_THE_BUTTONS_TO_PERFORM_THE_ACTIONS'); ?></div>
