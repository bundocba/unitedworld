...
class ose_antihackerViewaddips extends ose_antihackerView {
	function display($tpl= null) {
		...
		oseHTML::script($com.'/grid/menu/EditableItem.js', false);
		oseHTML::script($com.'/grid/rowEditor.js', false);
		oseHTML::script($com.'/grid/GridFilters.js',false);
		oseHTML::script($com.'/grid/filter/Filter.js',false);
		oseHTML::script($com.'/grid/menu/RangeMenu.js',false);
		...
		JHTML :: stylesheet('style.css', 'administrator/components/com_ose_antihacker/assets/css/');
		...
		$this->assignRef('title', JText :: _('OSE Anti-Hacker™ Add IPs'));
