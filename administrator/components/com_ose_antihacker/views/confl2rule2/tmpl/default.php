...
include(JPATH_ADMINISTRATOR.DS.'components/com_ose_antihacker/views/confl2rule2/tmpl/js.php');
...
?>
	<div class="section">
		...
		<div class="grid-title"><?php echo JText::_('PLS_ENTER_ADMIN_EMAIL_LONG'); ?></div>
			<div id ='l2rule2conf'></div>
	</div>
  </div>
</div>
