...
?>
		<style type="text/css">
			...
			#border-top.h_green {
				background: url("components/com_ose_antihacker/assets/images/installer.png") no-repeat scroll 0 0 transparent;
				height: 54px;
			}
...
?>
		...
		<div id="stepbar">
			...
			<div class="m">
				...
				<div class="steps<?php if($activeSteps == 5) echo " on"; ?>">5 : Installing Scanning Files</div>
				...
				<div class="m">
					...
					<div style="position: absolute; top: 8px; right: 10px;">
						<div id="communityContainer">
							...
							{
							?>
							<form action="?option=com_ose_antihacker" method="POST" name="installform" id="installform">
