...
class IDS_Converter
{
     ...
     * @return string
     */
    public static function runAll($value, $scanner)
    {
    	foreach ( $scanner ->converters as $method) {
    ...
    */
    ...
    {
    	/* OSE: Not being used in future version
     ...
     * @return string
     */
    public static function runCentrifuge($value, oseAntihacker $monitor = null)
    {
        $threshold = 3.49;
        if (strlen($value) > 25) {
