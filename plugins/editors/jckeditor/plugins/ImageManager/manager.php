...
header("Expires: Sat, 26 Jul 1997 05:00:00 GMT"); // Date in the past
	...
	jckimport('ckeditor.authenticate');	// moved here by AW
	
	if(!JCKAuthenticate::check())
	{
...
/*<![CDATA[*/
	...
	if (!this.I18N)
	{
		...
		document.write('<script type="text/javascript" src="lang/' + window.opener.CKEDITOR.config._editor_lang + '.js"><\/script>');
	}
...
/*]]>*/
	...
	if(opener.CKEDITOR)
		 var Dialog = opener.CKEDITOR._imgMan_Dialog;
	else
		var Dialog = opener.Dialog;
	Dialog._addEvent(window,"load",Dialog._fieLoadEvents);
	*/       
</script>
...
<?php } ?>
	...
	<iframe src="<?php echo (isset($dir) && isset($img)  ? 'images.php?dir=' . $dir .'&img=' . $img :  'images.php'); ?>" name="imgManager" id="imgManager" class="imageFrame" scrolling="auto" title="Image Selection" frameborder="0"></iframe>
</div>
</fieldset>
<!-- image properties -->
...
<!--// image properties -->	
	<div  style="text-align: right;"> 
          <hr />
		  <!-- button id="search" name="search" type="button" class="buttons">Search</button //-->
